...
export const GetConshifterProfileSchema = Joi.object({
  user: Joi.any().required().description("The authenticated user context"),
}).description("Schema for fetching Conshifter user profile");
...
export const UpdateUserRoleSchema = Joi.object({
  ...
  role: Joi.string()
    .valid(...Object.values(ConshifterRole))
    .required()
    .description("New Conshifter role to assign"),
